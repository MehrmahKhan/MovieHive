        ...
        <div className="moviehive-page" style={{ fontFamily: "'Poppins', sans-serif" }}>
            ...
            <div className="moviehive-shell max-w-2xl mx-auto px-8 py-6">
                <div className="moviehive-panel">
                    <h1 className="text-3xl font-light mb-6 moviehive-accent">Profile</h1>
                    {loading ? (
                        <p className="moviehive-subtle">Loading profile...</p>
                    ) : (
                        <form onSubmit={handleSave} className="space-y-4" style={{ backgroundColor: 'rgba(255,255,255,0.04)', border: '1px solid rgba(244,211,32,0.14)', borderRadius: 18, padding: 20 }}>
                            <div>
                                <label className="block text-sm mb-2 moviehive-subtle">Name</label>
                                <input
                                    value={name}
                            ...
                            <div>
                                <label className="block text-sm mb-2 moviehive-subtle">Email</label>
                                <input
                                    type="email"
                                    value={email}
